...
@router.get('/read_project_document_type/{id}',  response_model=Project_Document_Type)
...
@router.get('/read_project_document_types', response_model=List[Project_Document_Type])
...
@router.post('/create_project_document_type', response_model= Project_Document_Type)
...
@router.put('/update_project_document_type/{id}', response_model= Project_Document_Type)
...
@router.delete('/delete_project_document_type/{id}', response_model= Project_Document_Type)
